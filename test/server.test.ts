...
test("serves the app and reports health", async () => {
    ...
    assert.match(duelHtml, /id="pvpDeckSelectScreen"/);
    assert.match(duelHtml, /function renderPvpDeckSelection/);
    assert.match(duelHtml, /selectPvpDeck/);
    ...
    assert.match(duelHtml, /copyMultiplayerRoomCode/);
    ...
    assert.match(duelHtml, /multiplayerDuelSync\.summon/);
    assert.match(duelHtml, /multiplayerDuelSync\.activate/);
    assert.match(duelHtml, /multiplayerDuelSync\.fusionSummon/);
    assert.match(duelHtml, /multiplayerDuelSync\.changePosition/);
